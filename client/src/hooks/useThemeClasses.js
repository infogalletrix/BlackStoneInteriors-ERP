...
export function useThemeClasses() {
  ...
  return {
    ...
    page: d
      ...
      : "bg-[var(--bg)] text-[var(--text-primary)] min-h-screen font-sans relative overflow-hidden",
    ...
    // ── Typography ──────────────────────────────────────────────────
    heading: d ? "text-white font-bold text-base" : "text-[var(--text-primary)] font-bold text-base",
    subheading: d ? "text-slate-300 font-semibold text-sm" : "text-[var(--text-secondary)] font-semibold text-sm",
    ...
    input: d
      ...
      : "w-full p-2 border border-[var(--border-color)] rounded-lg bg-white outline-none focus:border-[#C9A227] focus:ring-1 focus:ring-[#C9A227]/20 text-[var(--text-primary)] font-medium text-xs transition",

    select: d
      ? "border border-white/10 rounded-lg bg-black/20 text-white outline-none focus:border-violet-500 [&>option]:bg-slate-900"
      : "border border-[var(--border-color)] rounded-lg bg-white text-[var(--text-primary)] outline-none focus:border-[#C9A227] [&>option]:bg-white",
    ...
    btnSecondary: d
      ...
      : "bg-white hover:bg-[var(--bg)] border border-[var(--border-color)] text-[var(--text-primary)] font-semibold text-xs rounded-lg transition",
    btnDanger: d
    ...
    tableHead: d
      ...
      : "bg-[var(--bg)] border-b border-[var(--border-color)] text-[#6B7C99] text-[9px] font-bold uppercase tracking-widest",
    tableRow: d
      ? "border-b border-white/5 hover:bg-white/5 transition"
      : "border-b border-[var(--border-color)] hover:bg-[#F9FAFB] transition",
    tableCell: d ? "text-slate-200 font-medium text-xs" : "text-[var(--text-primary)] font-medium text-xs",
    ...
    // ── Dividers ─────────────────────────────────────────────────────
    divider: d ? "bg-white/10" : "bg-[var(--border-color)]",
    borderClass: d ? "border-white/10" : "border-[var(--border-color)]",
    ...
    modalOverlay: d ? "bg-black/60 backdrop-blur-sm" : "bg-[var(--text-primary)]/30 backdrop-blur-sm",
    modalHeader: d ? "bg-black/20 border-b border-white/10" : "bg-[var(--bg)] border-b border-[var(--border-color)]",

    // ── Section header (stat pills) ─────────────────────────────────
    statPill: d
      ? "bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-4"
      : "bg-white border border-[var(--border-color)] rounded-2xl p-4 shadow-sm",
  };
}
