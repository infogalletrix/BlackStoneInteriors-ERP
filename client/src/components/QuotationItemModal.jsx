...
export default function QuotationItemModal({
  ...
  const handleSpecificationChange = (selectedSpecName) => {
    ...
    if (found && typeof found === "object") {
      ...
      if (found.discountType === "price" && found.discountPrice !== undefined && found.discountPrice !== null && Number(found.discountPrice) > 0) {
        setDiscountType("price");
        handleDiscountPriceChange(String(found.discountPrice));
      } else if (found.discountPercent !== undefined && found.discountPercent !== null && Number(found.discountPercent) > 0) {
        setDiscountType("percent");
