...
export default function AttendancePage() {
  ...
  return (
    <div className="p-4 md:p-6 page-wrapper">
      {/* HEADER SECTION */}
      <div className="flex flex-col md:flex-row justify-between items-center mb-3 gap-2 relative z-10">
        <div>
        ...
        {[
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-4 py-2 rounded-t-xl text-sm font-bold transition-all ${
              activeTab === tab.id
                ? "bg-[var(--bg-card)] text-accent border-t-2 border-l border-r border-[var(--border-color)] shadow-sm translate-y-[1px]"
            ...
            <div className="themed-card p-4 rounded-2xl shadow-sm flex flex-col justify-between h-24">
              ...
              <div className="relative flex items-center gap-2">
                ...
                <input
                  ...
                  className={`w-full text-lg font-black bg-transparent outline-none ${activeTab === "history" ? "cursor-pointer focus:text-accent" : "text-slate-400 cursor-not-allowed"}`}
                />
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center mb-4 gap-3 themed-card p-3 rounded-2xl shadow-sm">
            <div className="flex items-center gap-3">
              <button
                ...
                disabled={isLocked}
                className="text-xs font-bold text-accent hover:underline disabled:opacity-50 disabled:hover:no-underline px-2"
              >
                Mark All Present
              </button>
              {isLocked && (
              ...
              {isLocked ? (
                ...
                <>
                  <button
                    ...
                    className="bg-accent/10 text-accent px-4 py-2 text-sm rounded-xl font-bold flex items-center gap-1.5 transition hover:bg-accent/20"
                  >
                    <Save size={16} /> Save Draft
                  </button>
                  <button
                    onClick={() => saveAttendance(true)}
                    className="bg-accent text-white px-4 py-2 text-sm rounded-xl font-bold shadow-md flex items-center gap-1.5 transition hover:bg-accent-hover"
                  >
        ...
        <div className="themed-card p-4 rounded-2xl shadow-sm mb-4 flex items-center gap-3 max-w-sm">
          ...
          <div className="flex-1">
            ...
            <input
              ...
              className="w-full text-base font-black bg-transparent outline-none cursor-pointer focus:text-accent"
            />
          </div>
        </div>
      )}
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-1.5 max-w-[100px]">
                          <input 
                            ...
                            disabled={isLocked}
                            placeholder="0"
                            className="w-full p-1.5 border border-[var(--border-color)] rounded-lg themed-input font-bold text-xs outline-none focus:border-accent transition-colors disabled:opacity-50"
                          />
