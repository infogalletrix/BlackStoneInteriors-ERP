...
export default function HistoryPage() {
  ...
  const handlePrint = useReactToPrint({ contentRef: componentRef, preserveAfterPrint: true });

  const receiptComponentRef = useRef();
  const handleReceiptPrint = useReactToPrint({ contentRef: receiptComponentRef, preserveAfterPrint: true });
